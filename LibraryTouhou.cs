...
namespace WesternLauncherOfEasternOrigins
{
    ...
    {
        public static string VersionDate { get; set; } = "January 7 2026";
        public static Version VersionNumber { get; set; } = new Version(1, 0, 4); //Version Numbers (in order) are Major.Minor.Build.Revision
