...
namespace WesternLauncherOfEasternOrigins
{
    ...
    {
        public static string VersionDate { get; set; } = "Augest 29 2025";
        public static Version VersionNumber { get; set; } = new Version(1, 0, 3); //Version Numbers (in order) are Major.Minor.Build.Revision
